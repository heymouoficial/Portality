...
import { arrayBufferToBase64, base64ToArrayBuffer, pcmToAudioBuffer } from "../utils/audioUtils";
// Tool: Create Task
...
export class GeminiLiveService {
    ...
    startAudioStreaming(sessionPromise) {
        ...
        this.processor = workletNode; // Cast for compatibility with disconnect logic
    ...
    async handleServerMessage(message, sessionPromise) {
    ...
    async playAudioChunk(base64Audio) {
        if (!this.outputAudioContext || !this.gainNode)
            return;
        try {
